                            ...
                            <div class="col-md-6">
                                <nav id="header-nav-top">
                                    <ul class="list-inline pull-right" id="headermenu">
                                        ...
                                        <li>
                                        <a href="{{route('userlogout')}}"><i class="fa fa-share-square-o"></i> Checkout</a>
                                        </li>
                                        @endif
                        ...
                        <div class="box-left box-menu">
                           ...
                           <!--  <marquee direction="down" onmouseover="this.stop()" onmouseout="this.start()"  > -->
                            <ul>
                                ...
                                <li class="clearfix">
                                    <a href="">
                                        <img src="{{asset('user')}}/images/16-270x270.png" class="img-responsive pull-left" width="80" height="80">
                        ...
                        <section class="box-main1">
                            ...
                            <div class="showitem">
                                ...
                                <div class="col-md-3 item-product bor">
                                    ...
                                    <div class="info-item">
                                    <a href="">{{$item->name}}</a>
                                    <p><strike class="sale">19.000.000 đ</strike> <b class="price">{{$item->price}}</b></p>
                                    </div>
                                    <div class="hidenitem">
                            ...
                            <div class="col-md-3" id="footer-support">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <p><i class="sp-ic fa fa-mobile" style="font-size: 22px;padding-right: 5px;"></i> </p>
                                        <p><i class="sp-ic fa fa-envelope" style="font-size: 13px;padding-right: 5px;"></i> </p>
                                    </li>
                                </ul>
                            </div>
                        </div>
